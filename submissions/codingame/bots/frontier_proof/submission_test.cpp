...
#define PAPER_SOCCER_FRONTIER_PROOF_TESTING
#include "bot.cpp"
#undef PAPER_SOCCER_FRONTIER_PROOF_TESTING
...
#define PAPER_SOCCER_FRONTIER_LEAF_REFERENCE
#define turn_action_v2 leaf_reference_engine
#include "bot.cpp"
#undef turn_action_v2
#undef PAPER_SOCCER_FRONTIER_LEAF_REFERENCE
