...
| 12,500 nodes | 106 | 56-50 | 28 / 28 | 0 |
| 15,000 nodes | 106 | 53-53 | 30 / 23 | 0 |
| 20,000 nodes | 106 | 61-45 | 34 / 27 | 0 |
...
The gains at 5k, 20k, and 30k are repeatable and useful progress, but the
negative 10k result exposes horizon sensitivity and the equal-clock result is
not a promotion result. Timed screens varied from 9-9 in an earlier run to the
final isolated 8-10; neither is a clear improvement. The candidate therefore
remains an experiment and rank 4 remains live.
